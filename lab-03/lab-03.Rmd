...
The first histogram compares the number of mortgages between California and Washington, showing that both states have most of their counties clustered at lower mortgage counts, though Washington has a wider spread and some high-value outliers.The second histogram displays the distribution of outstanding mortgage values for Alaska and Texas, indicating that while most values are concentrated at around 750, Texas exhibits a broader range of mortgage values compared to Alaska. 
